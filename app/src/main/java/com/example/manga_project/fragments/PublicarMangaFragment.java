...
public class PublicarMangaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_manga_register, container, false);
    ...
    private void mapearUi(View v) {
        ...
        v.findViewById(R.id.btnBack)
                .setOnClickListener(btn -> requireActivity().getSupportFragmentManager().popBackStack());
        ...
        v.findViewById(R.id.btnUploadPdf)
                .setOnClickListener(btn -> pickZipLauncher.launch("application/zip"));

        ((Button) v.findViewById(R.id.btnPublish))
                .setOnClickListener(btn -> publicarComic());
    }
